"""Receivables and payables health report service."""
...
from .metrics import open_move_domain


def build_receivables_health(
    client,
    *,
    top_n: int = 5,
    ...
    invoices, truncation = fetch_with_truncation(
        ...
        "account.move",
        open_move_domain(
            context, move_types=("out_invoice", "in_invoice")
        ),
        fields=[
