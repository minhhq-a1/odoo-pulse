...
pytest tests/unit/tools/test_tools_write.py::test_create_record_preview_does_no_write
...
- `src/odoo_pulse/services/` — pure Python business logic services (record read, write execution, reports, project queries)
